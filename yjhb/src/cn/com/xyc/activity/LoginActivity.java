...
public class LoginActivity extends BaseActivity {
	...
	public void initView() {
		...
		lttotalfee.getValueText().setText("650元");
	}
	...
	protected void registerListener() {
		...
		ltdate.setOnClickListener(new OnClickListener() {			
				public void onClick(View v) {
					DatePicker	birth = new DatePicker(LoginActivity.this, new DateTimeSetListener() {
					...
					birth.showAtLocation(LoginActivity.this.findViewById(R.id.root),
							Gravity.BOTTOM, 0, 0);
				}
			});
