...
public class Constant {
	public static String ServerURL = "http://192.168.1.102:8080/";
	
	
	public static String METHOD_GET_AUTO_CODE="client/getAuthCode";
	public static String METHOD_LOGIN="client/getLatestUserByMobile";
